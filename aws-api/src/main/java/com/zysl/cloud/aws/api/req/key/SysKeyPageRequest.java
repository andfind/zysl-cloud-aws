...
@Setter
@Getter
@ApiModel(description = "分页查询操作请求对象")
public class SysKeyPageRequest extends BasePaginationRequest {
	
	
	private static final long serialVersionUID = 6694494605320100374L;
